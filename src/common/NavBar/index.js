...
class NavBar extends Component {
  ...
  render() {
    ...
    return (
      <div className={styles.wrapper} style={{ bottom: tabShow ? '0' : '-100px'}}>
        <div className={styles.navItem} onClick={() => handleNavChange(1)}>
          {
            currentTab === 1 ? 
            <img className={styles.itemHomeIconFull} src="/images/home-full.png" alt="" /> :
        ...
        <div className={styles.navItem} onClick={() => handleNavChange(2)}>
          {
            currentTab === 2 ? 
            <img className={styles.itemIcon} src="/images/vip-full.png" alt="" /> :
            <img className={styles.itemIcon} src="/images/vip.png" alt="" />
          }
          <p className={styles.itemName}>会员</p>
        </div>
        <div className={styles.navItem}>
          <div className={styles.itemAddIcon}>
            +
          </div>
        </div>
        <div className={styles.navItem} onClick={() => handleNavChange(3)}>
          {
            currentTab === 3 ? 
            <img className={styles.itemIcon} src="/images/note-full.png" alt="" /> :
        ...
        <div className={styles.navItem} onClick={() => handleNavChange(4)}>
          {
            currentTab === 4 ? 
            <img className={styles.itemIcon} src="/images/mine-full.png" alt="" /> :
